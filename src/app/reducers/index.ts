 ...
 */
import gamesReducer, * as fromGames from './games';
 ...
 * 	  this.gamesState$ = state$.let(getGamesState());
 * 	}
 * }
 * ```
 */
 ...
 */
 export function getGameEntities() {
   return compose(fromGames.getGameEntities(), getGamesState());
 }

 export function getGame(id: string) {
   return compose(fromGames.getGame(id), getGamesState());
 }

 export function hasGame(id: string) {
   return compose(fromGames.hasGame(id), getGamesState());
 }

 export function getGames(gameIds: string[]) {
   return compose(fromGames.getGames(gameIds), getGamesState());
 }
